...
//Lam moi trang de ap dung cookie
	...
	public void TC01_ViewOfList() throws InterruptedException {
		...
		driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
		driver.findElement(By.linkText("Học kỳ")).click();
		Thread.sleep(3000);
		// Xem danh sách ngành theo danh sách hiển thị (10,25,50,tất cả)
		WebElement listBoxFieldElement1 = driver.findElement(By.xpath(
				"/html[1]/body[1]/div[2]/div[2]/div[3]/div[1]/section[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[1]/div[1]/div[1]/div[1]/label[1]/select[1]"));
		Thread.sleep(1000);
		...
		Thread.sleep(1000);
		js3.executeScript("window.scrollBy(0, 5500)", "");
		Thread.sleep(3000);
	}
	@AfterClass
