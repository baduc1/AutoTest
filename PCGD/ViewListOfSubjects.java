...
public class ViewListOfSubjects {
	WebDriver driver;
...
//Lam moi trang de ap dung cookie
	...
	public void TC01_ViewOfList() throws InterruptedException {
		...
		// Định vị và nhấp vào ô chứa ngành
				WebElement termContainer = driver.findElement(By.xpath("//span[@id='select2-major-container']"));
				termContainer.click();
				// Định vị và chọn ngành tất cả trong danh sách
				WebElement termOption = driver.findElement(By.xpath("//li[text()='Tất cả']"));
				termOption.click();
		// Xem danh sách ngành theo danh sách hiển thị (10,25,50,tất cả)
		WebElement listBoxFieldElement1 = driver.findElement(By.xpath(
				"/html[1]/body[1]/div[2]/div[2]/div[3]/div[1]/section[1]/div[1]/div[1]/div[1]/div[2]/div[2]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/label[1]/select[1]"));
		Thread.sleep(1000);
