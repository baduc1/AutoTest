...
public class ViewSubjectsInTerm {
	WebDriver driver;
...
// Xem theo biểu đồ
	...
	public void TC01_TKSGGV() throws InterruptedException {
		...
		// Định vị và chọn học kỳ 221 trong danh sách
		WebElement termOption1 = driver.findElement(By.xpath("//li[text()='998']"));
		termOption1.click();
		Thread.sleep(3000);
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath(
				"/html[1]/body[1]/div[2]/div[2]/div[3]/div[1]/section[1]/div[1]/div[1]/div[1]/div[2]/div[2]/div[2]/div[2]/div[2]/div[1]/div[1]/table[1]/tbody[1]/tr[1]/td[2]/button[1]"))
				.click();
		Thread.sleep(2000);
