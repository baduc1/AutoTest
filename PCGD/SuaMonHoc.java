...
//Lam moi trang de ap dung cookie
	...
	public void TC01() throws InterruptedException {
		...
		// Định vị và nhấp vào ô chứa học kỳ
				...
				// Định vị và chọn học kỳ 221 trong danh sách
				WebElement termOption1 = driver.findElement(By.xpath("//li[text()='Team10']"));
				termOption1.click();
				Thread.sleep(3000);
		...
		// Chỉnh sửa môn học
		driver.findElement(By.xpath(
				"/html[1]/body[1]/div[2]/div[2]/div[3]/div[1]/section[1]/div[1]/div[1]/div[1]/div[2]/div[2]/div[1]/div[1]/div[1]/table[1]/tbody[1]/tr[1]/td[6]/a[1]/i[1]"))
				.click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("//input[@id='is_vietnamese']")).click();
		WebElement SubmitButton = driver
				.findElement(By.xpath("/html[1]/body[1]/div[3]/div[2]/form[1]/div[4]/button[2]"));
		SubmitButton.click();
		...
		// Kiểm tra xem thông báo có đúng với mong đợi hay không
		String expectedMessage = "Cập nhật thành công!";
		if (message.equals(expectedMessage)) {
		    System.out.println("Thông báo đúng với mong đợi.");
		} else {
		    System.out.println("Thông báo không đúng với mong đợi.");
		}
		Thread.sleep(2000);
