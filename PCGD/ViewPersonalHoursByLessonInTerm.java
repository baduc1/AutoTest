...
public class ViewPersonalHoursByLessonInTerm {
	WebDriver driver;
...
// Xem theo biểu đồ
	...
	public void TC01_TKSGGV() throws InterruptedException {
		...
		WebElement termOption = driver.findElement(By.xpath("//li[text()='Học kỳ']"));
		termOption.click();
		WebElement termContainer1 = driver.findElement(By.xpath("//span[@id='select2-term-container']"));
		termContainer1.click();
		// Định vị và chọn học kỳ 221 trong danh sách
		WebElement termOption1 = driver.findElement(By.xpath("//li[text()='999']"));
		termOption1.click();
		Thread.sleep(3000);
	}
...
// Xem theo bảng biểu, xuất ra file excel
	...
	public void TC03_TKSGGV() throws InterruptedException {
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath(
				"/html[1]/body[1]/div[2]/div[2]/div[3]/div[1]/section[1]/div[1]/div[1]/div[1]/div[2]/div[2]/div[2]/div[2]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[2]/button[1]/span[1]"))
				.click();
		Thread.sleep(2000);
		driver.findElement(By.xpath(
				"/html[1]/body[1]/div[2]/div[2]/div[3]/div[1]/section[1]/div[1]/div[1]/div[1]/div[2]/div[2]/div[2]/div[2]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[2]/div[2]/div[1]/button[2]/span[1]"))
				.click();
		Thread.sleep(2000);
	}
...
//Xem theo bảng biểu, xuất ra file PDF
	...
	public void TC04_TKSGGV() throws InterruptedException {
		driver.findElement(By.xpath(
				"/html[1]/body[1]/div[2]/div[2]/div[3]/div[1]/section[1]/div[1]/div[1]/div[1]/div[2]/div[2]/div[2]/div[2]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[2]/div[2]/div[1]/button[3]/span[1]"))
				.click();
		Thread.sleep(2000);
	}
...
//Xem theo bảng biểu, In ấn
	...
	public void TC05_TKSGGV() throws InterruptedException {
		driver.findElement(By.xpath(
				"/html[1]/body[1]/div[2]/div[2]/div[3]/div[1]/section[1]/div[1]/div[1]/div[1]/div[2]/div[2]/div[2]/div[2]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[2]/div[2]/div[1]/button[1]/span[1]"))
				.click();
		Thread.sleep(2000);
	}
...
//Xem theo bảng biểu, sao chép
	...
	public void TC06_TKSGGV() throws InterruptedException {
		driver.findElement(By.xpath(
				"/html[1]/body[1]/div[2]/div[2]/div[3]/div[1]/section[1]/div[1]/div[1]/div[1]/div[2]/div[2]/div[2]/div[2]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[2]/div[2]/div[1]/button[4]"))
				.click();
	}
	@AfterClass
