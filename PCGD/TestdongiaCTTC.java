...
import org.testng.annotations.Test;
	  ...
	  @Test(priority = 0)
	    public void updateAndDeleteCTĐTtieuchuan() throws InterruptedException {
		  WebElement termContainer = driver.findElement(By.xpath("//*[@id=\"select2-year-container\"]"));
	        ...
	        driver.findElement(By.xpath("//tbody/tr[7]/td[3]/a[2]/i[1]")).click(); 
	        Thread.sleep(2000);
	  ...
	  public void updatesuatatcad() throws InterruptedException {
	    ...
	    WebElement tadsuatatcaTC = driver.findElement(By.xpath("//body/div[2]/div[2]/div[3]/div[1]/section[1]/div[1]/div[1]/div[1]/div[2]/div[2]/div[2]/div[1]/div[1]/div[1]/div[1]/div[1]/button[1]"));
	    tadsuatatcaTC.click();
